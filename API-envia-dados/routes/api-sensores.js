...
router.get("/sendData", (request, response) => {
	...
	if (env == "dev") {
		...
		instrucaoSql = `INSERT into historico_temp (temp_sen, data_hora_regis, id_sensor)
		...
		instrucaoSql = `INSERT into dbo.historico_temp (temperatura, umidade, momento, fkcaminhao)
		values (${temperature}, ${Humidity + 20}, '${agora()}', 1);`;
	}
